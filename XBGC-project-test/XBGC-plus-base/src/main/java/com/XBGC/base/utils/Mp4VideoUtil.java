...
public class Mp4VideoUtil extends VideoUtil {
    //ffmpeg的路径
    String ffmpeg_path = "C:\\Users\\LENOVO\\Desktop\\常用软件工具\\ffmpeg.exe";//ffmpeg的安装位置
...
//        Process p = builder.start();
        ...
        String ffmpeg_path = "C:\\Users\\LENOVO\\Desktop\\常用软件工具\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\LENOVO\\Desktop\\upload\\avi\\02-概述-分库分表是什么.avi";
        //转换后mp4文件的名称
        String mp4_name = "02-概述-分库分表是什么.mp4";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\LENOVO\\Desktop\\upload\\mp4\\02-概述-分库分表是什么.mp4";
        //创建工具类对象
