package com.XBGC.orders.service.impl;
...
import com.XBGC.base.utils.IdWorkerUtils;
import com.XBGC.base.utils.QRCodeUtil;
import com.XBGC.messagesdk.model.po.MqMessage;
import com.XBGC.messagesdk.service.MqMessageService;
import com.XBGC.orders.config.AlipayConfig;
import com.XBGC.orders.config.PayNotifyConfig;
import com.XBGC.orders.mapper.XcOrdersGoodsMapper;
import com.XBGC.orders.mapper.XcOrdersMapper;
import com.XBGC.orders.mapper.XcPayRecordMapper;
import com.XBGC.orders.model.dto.AddOrderDto;
import com.XBGC.orders.model.dto.PayRecordDto;
import com.XBGC.orders.model.dto.PayStatusDto;
import com.XBGC.orders.model.po.XcOrders;
import com.XBGC.orders.model.po.XcOrdersGoods;
import com.XBGC.orders.model.po.XcPayRecord;
import com.XBGC.orders.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PayRecordDto createOrder(String userId, AddOrderDto addOrderDto) {
        ...
        try {
            ...
            XBGCPlusException.cast("生成二维码出错");
        }
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo){
        ...
        try {
            ...
            if(!response.isSuccess()){//交易不成功
                XBGCPlusException.cast("请求支付宝查询支付结果失败");
            }
            body = response.getBody();
        } catch (AlipayApiException e) {
            e.printStackTrace();
           XBGCPlusException.cast("请求支付查询支付结果异常");
        }
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto){
        ...
        if(payRecordByPayno == null){
            XBGCPlusException.cast("找不到相关的支付记录");
        }
        //拿到相关联的订单id
        Long orderId = payRecordByPayno.getOrderId();
        XcOrders xcOrders = ordersMapper.selectById(orderId);
        if(xcOrders == null){
            XBGCPlusException.cast("找不到相关联的订单");
        }
        //支付状态
    ...
    public XcPayRecord createPayRecord(XcOrders orders){
        ...
        if(insert<=0){
            XBGCPlusException.cast("插入支付记录失败");
        }
        return xcPayRecord;
    }
